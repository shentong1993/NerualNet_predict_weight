...
trainDataList = processData(filePath='./data/f3.csv')
...
for person in trainDataList:
    ...
    if thigh>75 or thigh < 43:
        trainDataList.remove(person)
        continue
    if bmi >22 and bmi <23 and thigh > 65:
        trainDataList.remove(person)
        continue

    bmiList.append(bmi)
    hiplineList.append(thigh)
...
with open("./data/f4.csv", "w", encoding='utf8') as csvfile:
