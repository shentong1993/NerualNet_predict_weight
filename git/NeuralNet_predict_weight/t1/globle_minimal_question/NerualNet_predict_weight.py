...
testDataList = processData(filePath='/home/shen/Trying/Predict/up/t1/globle_minimal_question/data_cut/data_cut0/test.csv')
...
predictWeight = tf.subtract( x_data[:,0],tf.multiply(final_output ,10) )
...
# # Training loop
checkpoint_dir = '/home/shen/Trying/Predict/up/t1/globle_minimal_question/Net_save/net_save0/'
...
# predict_weight =sess.run(final_output, feed_dict={x_data: x,y_target: y,}
#                                       )
# print (predict_weight)
# print (predict_weight.shape)
# print (type(predict_weight))
