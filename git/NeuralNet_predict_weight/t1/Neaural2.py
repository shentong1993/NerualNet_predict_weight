...
trainDataList = processData(filePath='/home/shen/Trying/Predict/up/t1/data2/train.csv')
...
(testDatas, testLabels) = generateDataAndLabel(type='weight', metaDatas=trainDataList, week=1)
...
learn_rate = tf.train.exponential_decay(0.005, global_step,
