...
def normalize_cols(m):
    ...
    with open("/home/shen/Trying/Predict/up/t1/NerualNet_struct/final_version/min_max_for_predict/min_max_column.csv", "w", encoding='utf8') as csvfile:
...
trainDataList = processData(filePath='/home/shen/Trying/Predict/up/t1/NerualNet_struct/final_version/data/train.csv')
...
#x_vals_train = trainDatas


testDataList = processData(filePath='/home/shen/Trying/Predict/up/t1/NerualNet_struct/final_version/data/test.csv')
...
# save_dir ='/home/shen/Trying/Predict/up/t1/NerualNet_struct/final_version/Net_save/'
