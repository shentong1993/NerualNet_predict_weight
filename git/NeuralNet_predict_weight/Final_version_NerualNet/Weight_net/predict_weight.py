...
def normalize_cols(m):
    max_col = []
    min_col = []
    with open('/home/shen/Trying/Predict/up/Final_version_NerualNet/Weight_net/min_max_for_predict/min_max_column.csv',
              'r') as f:
        records = f.readlines()
...
# Training loop
checkpoint_dir = '/home/shen/Trying/Predict/up/Final_version_NerualNet/Weight_net/Net_save/'
