...
trainDataList = processData(filePath='/home/shen/Trying/Predict/up/Two_out_Net/data/trainData.csv')
...
testDataList = processData(filePath='/home/shen/Trying/Predict/up/Two_out_Net/test_data/trainData.csv')
...
weight_5 = init_weight(shape=[8,2], st_dev=1.0)
bias_5 = init_bias(shape=[2], st_dev=1.0)
...
checkpoint_dir = '/home/shen/Trying/Predict/up/Two_out_Net/Net_save/'
...
x = x_vals_test
y = testLabels
print("Testing Accuracy:", sess.run(accuracy_weight*100, feed_dict={x_data: x,y_target: y}
                                      ))
print("Testing Accuracy:", sess.run(accuracy_waist*100, feed_dict={x_data: x,y_target: y}
                                      ))
#
# num_all = y.shape[0]
# num_right = 0
