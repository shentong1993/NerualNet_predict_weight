...
origin_weight = [testDatas[:,2]]

transpose_o_weight = np.transpose(origin_weight)
#print ('origin_waistline0 = ', origin_weight)


predict_weight_old = transpose_o_weight - predict_weight_lost

#print (predict_weight_old)
#print (predict_weight_old[0][0])

output_waistline = predict_weight_old[0][0]

print (output_waistline)

print (round(output_waistline , 2))
