...
trainDataList = processData(filePath='/Users/shen/PycharmProjects/t1/data/trainData.csv')

len =  len(trainDataList)
print ("len = ", len)

# make train.csv
with open("/Users/shen/PycharmProjects/t1/data/train.csv", "w", encoding='utf8') as csvfile:
...
# make test.csv
with open("/Users/shen/PycharmProjects/t1/data/test.csv", "w", encoding='utf8') as csvfile:
    writer = csv.writer(csvfile)
